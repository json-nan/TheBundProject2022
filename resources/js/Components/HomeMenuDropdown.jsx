            ...
            {({ open }) => (
                <>
                    <div className="w-full group">
                        <Menu.Button className="flex items-center justify-between w-full pl-4 pr-2 text-sm font-medium bg-white hover:bg-gray-50">
                                            ...
                                            <a
                                                ...
                                                className={classNames(
                                                    active
                                                        ...
                                                        : "text-gray-700",
                                                    "block px-4 py-2 text-sm hover:bg-[#F0A31F]"
                                                )}
                                            >
                                                {generation.name}
                                            </a>
