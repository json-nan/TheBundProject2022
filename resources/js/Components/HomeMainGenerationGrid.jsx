const HomeMainGenerationGrid = ({ members }) => (
  <div className="relative home-generation bg-primary">
    <img
        ...
        <div className="grid grid-cols-2">
          ...
          <div className="col-span-1">
            <p className="text-white">
              Nuestra unión y conexión de mentes creativas reunidad para formar
              parte de un colectivo que buscan formar nexos y experiencias para
              el desarrollo e innovación de la industria creativa en El
              Salvador.
            </p>
          </div>
        </div>
